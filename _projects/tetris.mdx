...
and disliked using it at times due to the lack of customization and its bulkiness, and so for the styling I used
<code>Bulma</code>, as it was seen as a lightweight alternative.
...
exist to make creating frontend components more easily. It significantly reduces the need for <code>component_name.innerHTML</code>
